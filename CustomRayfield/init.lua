...
local RayfieldLibrary = {
    ...
    Strawberry = {
    TextColor = Color3.fromRGB(255, 215, 218),

    Background = Color3.fromRGB(14, 5, 7),
    Topbar = Color3.fromRGB(24, 8, 12),
    Shadow = Color3.fromRGB(6, 2, 3),

    NotificationBackground = Color3.fromRGB(20, 7, 10),
    NotificationActionsBackground = Color3.fromRGB(255, 30, 50),

    TabBackground = Color3.fromRGB(45, 12, 18),
    TabStroke = Color3.fromRGB(70, 18, 26),
    TabBackgroundSelected = Color3.fromRGB(255, 30, 50),
    TabTextColor = Color3.fromRGB(190, 120, 130),
    SelectedTabTextColor = Color3.fromRGB(255, 255, 255),

    ElementBackground = Color3.fromRGB(26, 9, 13),
    ElementBackgroundHover = Color3.fromRGB(38, 13, 19),
    SecondaryElementBackground = Color3.fromRGB(18, 6, 9),
    ElementStroke = Color3.fromRGB(65, 18, 26),
    SecondaryElementStroke = Color3.fromRGB(45, 13, 19),

    SliderBackground = Color3.fromRGB(80, 15, 22),
    SliderProgress = Color3.fromRGB(255, 30, 50),
    SliderStroke = Color3.fromRGB(255, 75, 90),

    ToggleBackground = Color3.fromRGB(22, 8, 11),
    ToggleEnabled = Color3.fromRGB(255, 30, 50),
    ToggleDisabled = Color3.fromRGB(75, 28, 34),
    ToggleEnabledStroke = Color3.fromRGB(255, 90, 105),
    ToggleDisabledStroke = Color3.fromRGB(100, 38, 46),
    ToggleEnabledOuterStroke = Color3.fromRGB(160, 22, 34),
    ToggleDisabledOuterStroke = Color3.fromRGB(45, 16, 20),

    DropdownSelected = Color3.fromRGB(42, 13, 18),
    DropdownUnselected = Color3.fromRGB(26, 9, 13),

    InputBackground = Color3.fromRGB(20, 7, 10),
    InputStroke = Color3.fromRGB(85, 22, 32),
    PlaceholderColor = Color3.fromRGB(175, 90, 100),
    }
